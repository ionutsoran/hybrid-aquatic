...
class BrownSeaweedBlock(settings: Settings?) : PlantBlock(settings), Fertilizable, FluidFillable {
    ...
    override fun grow(world: ServerWorld, random: Random, pos: BlockPos, state: BlockState) {
        val blockState = HybridAquaticBlocks.TALL_BROWN_SEAWEED.defaultState
